    ...
    <footer className="bg-white/15 backdrop-blur-xl border-t border-white/30 text-gray-800 py-8 saturate-150">
      <div className="max-w-5xl mx-auto px-6">
        ...
        <div className="flex justify-center mt-6 gap-6">
          <a href="https://www.facebook.com/profile.php?id=61574212569091" target="_blank" rel="noopener noreferrer" aria-label="Facebook" className="text-gray-600 hover:text-blue-600 transition duration-300">
          ...
          <a href="https://www.linkedin.com/company/cse-23/" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn" className="text-gray-600 hover:text-blue-700 transition duration-300">
            <svg fill="currentColor" className="w-5 h-5" viewBox="0 0 24 24">
        ...
        {/* Copyright */}
        <div className="border-t border-white/20 mt-6 pt-4 text-center text-xs text-gray-500">
